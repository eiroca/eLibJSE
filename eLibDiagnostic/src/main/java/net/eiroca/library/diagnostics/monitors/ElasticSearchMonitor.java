...
public class ElasticSearchMonitor extends GenericHTTPMonitor {
  ...
  protected final Measure mCompletionSize = mgElasticSearch.createMeasure("CompletionSize", "Size of completion caches", "bytes");
  protected final Measure mDataNodeCount = mgElasticSearch.createMeasure("DataNodeCount", "Number of active data nodes", "number");
  protected final Measure mDelayedUnassignedShards = mgElasticSearch.createMeasure("DelayedUnassignedShards", "The number of shards that are in delayed state", "number");
  protected final Measure mDeleteCurrent = mgElasticSearch.createMeasure("DeleteCurrent", "Currently active delete operations per node", "number");
  protected final Measure mDeletedCount = mgElasticSearch.createMeasure("DeletedCount", "Number of deleted documents", "number");
  protected final Measure mDocumentDeletedRate = mgElasticSearch.define("DeletedCountPerSecond", new RateMeasure(mDeletedCount, TimeUnit.SECONDS, 0.0), "Derived measure which provides the number of documents deleted per second since the monitor was last run", "number", "s");
  protected final Measure mDocumentCount = mgElasticSearch.createMeasure("DocCount", "Number of documents", "number");
  protected final Measure mDocumentRate = mgElasticSearch.define("DocCountPerSecond", new RateMeasure(mDocumentCount, TimeUnit.SECONDS, 0.0), "Derived measure which provides the number of documents added per second since the monitor was last run", "number", "s");
  protected final Measure mFetchCurrent = mgElasticSearch.createMeasure("FetchCurrent", "Currently active fetch operations per node", "number");
  protected final Measure mFieldDataEvictions = mgElasticSearch.createMeasure("FieldDataEvictions", "How often field data was evicted from the field data cache", "number");
  protected final Measure mFiledDataSize = mgElasticSearch.createMeasure("FieldDataSize", "Size of the field data per node", "bytes");
  protected final Measure mFileDescLimitPerNode = mgElasticSearch.createMeasure("FileDescriptorLimit", "File descriptor metrics split by different file descriptor measures", "number");
  protected final Measure mFileDescriptorCount = mgElasticSearch.createMeasure("FileDescriptorCount", "Allowed number of max file descriptor on the operating system split by node", "number");
  protected final Measure mFileSystemSize = mgElasticSearch.createMeasure("FileSystemSize", "File system metrics split by different file system measures", "bytes");
  protected final Measure mIndexCount = mgElasticSearch.createMeasure("IndexCount", "The count of indexes", "number");
  protected final Measure mIndexingCurrent = mgElasticSearch.createMeasure("IndexingCurrent", "Currently active indexing operations per node", "number");
  protected final Measure mIndexingThrottleTime = mgElasticSearch.createMeasure("IndexingThrottleTime", "Time that indexing was throttled per node", "ms", true);
  protected final Measure mInitializingShards = mgElasticSearch.createMeasure("InitializingShards", "The number of shards that are currently initializing", "number");
  protected final Measure mMemInitHeap = mgElasticSearch.createMeasure("InitHeap", "The number of bytes currently initialized on the heap per node", "bytes");
  protected final Measure mMemInitNonHeap = mgElasticSearch.createMeasure("InitNonHeap", "The number of bytes currently initialized off-heap per node", "bytes");
  protected final Measure mMemMaxDirect = mgElasticSearch.createMeasure("MaxDirect", "The number of bytes of direct memory that can be used per node", "bytes");
  protected final Measure mMemMaxHeap = mgElasticSearch.createMeasure("MaxHeap", "The number of bytes of heap-memory that can be used at max per node", "bytes");
  protected final Measure mMemMaxNonHeap = mgElasticSearch.createMeasure("MaxNonHeap", "The number of bytes of off-heap memory that can be used at max per node", "bytes");
  protected final Measure mNodeCount = mgElasticSearch.createMeasure("NodeCount", "Number of active nodes", "number");
  protected final Measure mPercolateCount = mgElasticSearch.createMeasure("PercolateCount", "Percolate metrics split by different percolate measures", "number");
  protected final Measure mPercolateSize = mgElasticSearch.createMeasure("PercolateSize", "Size used for percolation per node", "bytes");
  protected final Measure mQueryCacheSize = mgElasticSearch.createMeasure("QueryCacheSize", "Size of the query cache per node", "bytes");
  protected final Measure mQueryCurrent = mgElasticSearch.createMeasure("QueryCurrent", "Currently active query operations per node", "number");
  protected final Measure mRecoveryAsSource = mgElasticSearch.createMeasure("RecoveryAsSource", "Number of shards that are recovered from this node", "number");
  protected final Measure mRecoveryAsTarget = mgElasticSearch.createMeasure("RecoveryAsTarget", "Number of shards that are recovered to this node", "number");
  protected final Measure mRecoveryThrottleTime = mgElasticSearch.createMeasure("RecoveryThrottleTime", "Time that recovery was throttled per node", "ms", true);
  protected final Measure mRelocatingShards = mgElasticSearch.createMeasure("RelocatingShards", "The number of shards that are currently relocated", "number");
  protected final Measure mRequestCacheSize = mgElasticSearch.createMeasure("RequestCacheSize", "Size of the request cache", "bytes");
  protected final Measure mScrollCurrent = mgElasticSearch.createMeasure("ScrollCurrent", "Currently active scroll operations per node", "number");
  protected final Measure mSegmentCount = mgElasticSearch.createMeasure("SegmentCount", "Number of segments", "number");
  protected final Measure mSegmentSize = mgElasticSearch.createMeasure("SegmentSize", "Size of segments, split by different segment-measures", "bytes");
  protected final Measure mShardCount = mgElasticSearch.createMeasure("ShardCount", "The number of shards with dynamic splittings by state", "number");
  protected final Measure mStoreSize = mgElasticSearch.createMeasure("StoreSize", "Size of storage overall per node", "bytes");
  protected final Measure mStoreThrottleTime = mgElasticSearch.createMeasure("StoreThrottleTime", "Time that storing was throttled per node", "ms", true);
  protected final Measure mTranslogSize = mgElasticSearch.createMeasure("TranslogSize", "Size of the translog per node", "bytes");
